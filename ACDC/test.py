...
FLAGS = {
    'exp': 'train_cross_match_cross_match',
    'labeled_num': 7,
    'subfolder':'eta_0.3',
    'model': 'unet'
}
...
def Inference():
    ...
    snapshot_path = snapshot_path = f'exp/acdc/train_cross_match_cross_match/unet/7/eta_0.3'
    test_save_path = f"exp/acdc/train_cross_match_cross_match/unet/7/eta_0.3/predictions/"
...
# test.txt
# [0.87803082 0.78880633 2.55270953 0.69797061] best.pth

# val.txt
# [0.88185431 0.8008685  1.65514556 0.47607438] best.pth
